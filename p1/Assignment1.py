...
class Tree:
	...
	def add(self,value,parentValue):
		self.parent = self.checkTree(value,parentValue,self.root)
		if (self.parent):
			node = Node(value,None,None,self.parent)
	...
	def findNodeDelete(self, value, root):
		...
		if value == root.value:
			if root.leftChild == None and root.rightChild == None:
				if root.parent.leftChild.value == value:
					root.parent.leftChild = None
				elif root.parent.rightChild.value == value:
...
class Graph:
        ...
        def addEdge(self, value1, value2):
           ...
           if value1 not in self.verticies or value2 not in self.verticies:
	            ...
	            adjlst.append(value2)
	   # print(self.verticies[1])
